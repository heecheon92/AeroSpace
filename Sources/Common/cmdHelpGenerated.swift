...
let fullscreen_help_generated = """
    USAGE: fullscreen [-h|--help]     [--window-id <window-id>] [--no-outer-gaps] [--centered [--width <percent>] [--height <percent>] [--animation on|off]]
       OR: fullscreen [-h|--help] on  [--window-id <window-id>] [--no-outer-gaps] [--centered [--width <percent>] [--height <percent>] [--animation on|off]] [--fail-if-noop]
